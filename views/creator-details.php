              ...
              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                 ...
                 <div class="container d-flex justify-content-center mb-4" >
                  ...
                  <div class="form-group mb-3 d-flex justify-content-center" style="background-color: transparent;">
                    <input type="file" id="picture" onchange="pictureInput(event)" style="display: none;" name="file" />
                    <input id="pic-btn" type="button" class=" btn btn-primary rounded submit " value="Select Profile Picture"/>
                  </div>
