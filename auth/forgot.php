...
<body class="my-login-page" style="background-color: #060c22; ">
	<section class="h-100" style="margin-top:5%;">
		<div class="container h-100">
			<div class="row justify-content-md-center align-items-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body ">
							<h4 class="card-title d-flex justify-content-center">Forgot Password</h4>
							<form method="POST" class="my-login-validation" novalidate="">
								...
								<div class="form-group m-0">
									<button type="submit" class="btn btn-danger rounded btn-block">
										Reset Password
									</button>
								</div>
							</form>
